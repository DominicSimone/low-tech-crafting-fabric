...
public class AutoCraftingScreen
extends HandledScreen<AutoCraftingScreenHandler>
implements RecipeBookProvider {
    ...
    public AutoCraftingScreen(AutoCraftingScreenHandler handler, PlayerInventory inventory, Text title) {
