...
public class BoxScreenHandler extends ScreenHandler {
    ...
    public BoxScreenHandler(int syncId, PlayerInventory playerInventory) {
        ...
        Log.info(LogCategory.GENERAL, "BoxScreenHandler entry constructor");
    }
    ...
    public BoxScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
        super(LowTechCrafting.BOX_SCREEN_HANDLER, syncId);
        Log.info(LogCategory.GENERAL, "BoxScreenHandler chunky constructor");
